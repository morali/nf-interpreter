...
- {id: FLEXSPI2_CLK_ROOT.outFreq, value: 320 MHz}
- {id: FLEXSPI_CLK_ROOT.outFreq, value: 720/7 MHz}
- {id: GPT1_ipg_clk_highfreq.outFreq, value: 75 MHz}
- {id: GPT2_ipg_clk_highfreq.outFreq, value: 75 MHz}
- {id: IPG_CLK_ROOT.outFreq, value: 150 MHz}
- {id: LCDIF_CLK_ROOT.outFreq, value: 40 MHz}
- {id: LPI2C_CLK_ROOT.outFreq, value: 10 MHz}
- {id: LPSPI_CLK_ROOT.outFreq, value: 40 MHz}
...
- {id: CCM.FLEXSPI2_PODF.scale, value: '1'}
- {id: CCM.FLEXSPI2_SEL.sel, value: CCM_ANALOG.PLL3_PFD1_CLK}
- {id: CCM.FLEXSPI_PODF.scale, value: '4'}
...
- {id: CCM_ANALOG.PLL3_PFD0_DIV.scale, value: '21', locked: true}
...
- {id: IOMUXC_GPR.ENET1_CLK_SEL.sel, value: IOMUXC_GPR.ENET_TX_CLK_EXT}
sources:
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set USDHC2_PODF. */
    CLOCK_SetDiv(kCLOCK_Usdhc2Div, 7);
