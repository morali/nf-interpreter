...
static const CLR_RT_MethodHandler method_lookup[] =
{
    ...
    NULL,
    Library_isma_deviceinfo_native_iSMA_DeviceInfo_DeviceInfo::GetFirmwareVersionNative___STATIC__STRING,
    NULL,
    Library_isma_deviceinfo_native_iSMA_DeviceInfo_DeviceInfo::GetModelVersionNative___STATIC__STRING,
    NULL,
