...
void vTimeredTask10ms(void * argument)
{
	...
	while(1)
	{
		...
		/* Test output toggle */ 
		// local_io_tx.digital_output ^= 0xFF;
		// local_io_tx.ui_input ^= 0x01;
		// local_io_tx.analog_output ^= 0xff;
