...
static const CLR_RT_MethodHandler method_lookup[] =
{
    ...
    Library_isma_localio_native_iSMA_LocalIO_AO::SetDutyNative___VOID__U1,
    Library_isma_localio_native_iSMA_LocalIO_AO::SetVoltageNative___VOID__U2,
    Library_isma_localio_native_iSMA_LocalIO_AO::SetDigitalNative___VOID__BOOLEAN,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    Library_isma_localio_native_iSMA_LocalIO_LocalIOController::GetTOsNative___STATIC__SZARRAY_iSMALocalIOTO,
    NULL,
    NULL,
    NULL,
    NULL,
    ...
    NULL,
    NULL,
    Library_isma_localio_native_iSMA_LocalIO_TO::SetConfigNative___VOID,
    Library_isma_localio_native_iSMA_LocalIO_TO::SetDutyNative___VOID__U1,
    Library_isma_localio_native_iSMA_LocalIO_TO::SetDigitalNative___VOID__BOOLEAN,
    NULL,
    NULL,
    NULL,
    NULL,
