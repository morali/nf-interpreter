...
#endif /* __cplusplus */
int bvlc6_encode_address(uint8_t *pdu, uint16_t pdu_size, BACNET_IP6_ADDRESS *ip6_address);
int bvlc6_decode_address(uint8_t *pdu, uint16_t pdu_len, BACNET_IP6_ADDRESS *ip6_address);
...
bool bvlc6_address_set(BACNET_IP6_ADDRESS *addr, uint16_t addr0, uint16_t addr1, uint16_t addr2, uint16_t addr3, uint16_t addr4, uint16_t addr5, uint16_t addr6,
                       uint16_t addr7);
bool bvlc6_address_get(BACNET_IP6_ADDRESS *addr, uint16_t *addr0, uint16_t *addr1, uint16_t *addr2, uint16_t *addr3, uint16_t *addr4, uint16_t *addr5,
...
int bvlc6_decode_header(uint8_t *pdu, uint16_t pdu_len, uint8_t *message_type, uint16_t *length);

int bvlc6_encode_result(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac, uint16_t result_code);
int bvlc6_decode_result(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac, uint16_t *result_code);

int bvlc6_encode_original_unicast(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, uint32_t vmac_dst, uint8_t *npdu, uint16_t npdu_len);
int bvlc6_decode_original_unicast(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, uint32_t *vmac_dst, uint8_t *npdu, uint16_t npdu_size,
                                  uint16_t *npdu_len);

int bvlc6_encode_original_broadcast(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac, uint8_t *npdu, uint16_t npdu_len);
int bvlc6_decode_original_broadcast(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac, uint8_t *npdu, uint16_t npdu_size, uint16_t *npdu_len);

int bvlc6_encode_address_resolution(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, uint32_t vmac_target);
int bvlc6_decode_address_resolution(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, uint32_t *vmac_target);

int bvlc6_encode_forwarded_address_resolution(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, uint32_t vmac_target, BACNET_IP6_ADDRESS *bip6_address);
int bvlc6_decode_forwarded_address_resolution(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, uint32_t *vmac_target, BACNET_IP6_ADDRESS *bip6_address);

int bvlc6_encode_address_resolution_ack(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, uint32_t vmac_dst);
int bvlc6_decode_address_resolution_ack(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, uint32_t *vmac_dst);

int bvlc6_encode_virtual_address_resolution(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src);
int bvlc6_decode_virtual_address_resolution(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src);

int bvlc6_encode_virtual_address_resolution_ack(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, uint32_t vmac_dst);
int bvlc6_decode_virtual_address_resolution_ack(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, uint32_t *vmac_dst);

int bvlc6_encode_forwarded_npdu(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, BACNET_IP6_ADDRESS *address, uint8_t *npdu, uint16_t npdu_len);
int bvlc6_decode_forwarded_npdu(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, BACNET_IP6_ADDRESS *address, uint8_t *npdu, uint16_t npdu_size,
                                uint16_t *npdu_len);

int bvlc6_encode_register_foreign_device(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, uint16_t ttl_seconds);
int bvlc6_decode_register_foreign_device(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, uint16_t *ttl_seconds);

int bvlc6_encode_delete_foreign_device(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac_src, BACNET_IP6_FOREIGN_DEVICE_TABLE_ENTRY *fdt_entry);
int bvlc6_decode_delete_foreign_device(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac_src, BACNET_IP6_FOREIGN_DEVICE_TABLE_ENTRY *fdt_entry);

int bvlc6_encode_secure_bvll(uint8_t *pdu, uint16_t pdu_size, uint8_t *sbuf, uint16_t sbuf_len);
int bvlc6_decode_secure_bvll(uint8_t *pdu, uint16_t pdu_len, uint8_t *sbuf, uint16_t sbuf_size, uint16_t *sbuf_len);

int bvlc6_encode_distribute_broadcast_to_network(uint8_t *pdu, uint16_t pdu_size, uint32_t vmac, uint8_t *npdu, uint16_t npdu_len);
int bvlc6_decode_distribute_broadcast_to_network(uint8_t *pdu, uint16_t pdu_len, uint32_t *vmac, uint8_t *npdu, uint16_t npdu_size, uint16_t *npdu_len);

/* user application function prototypes */
int bvlc6_handler(BACNET_IP6_ADDRESS *addr, BACNET_ADDRESS *src, uint8_t *npdu, uint16_t npdu_len);
int bvlc6_register_with_bbmd(BACNET_IP6_ADDRESS *bbmd_addr, uint32_t vmac_src, uint16_t time_to_live_seconds);
